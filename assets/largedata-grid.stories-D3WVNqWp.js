import{j as a}from"./index-CTAXdLKx.js";import{r as p}from"./index-D5jfS-9e.js";import{C as R,a as G,u as vn,S as y,P as Re,D as ge,Q as me,i as bn,b as Ge,c as Me,d as xn,G as Dn,e as En,f as An,g as Tn,h as Rn,j as O,W as Gn,A as Z,k as Ce,l as dn,O as Mn,T as ke,U as kn,m as Fn}from"./useGridTheme-BOBPFhhd.js";import"./client-Spw3EFno.js";import{m as qn,a as Vn,u as zn,e as In,b as On,c as Pn}from"./data-Db9z3c_v.js";const Nn=[40,80,120,200],we=r=>{var be,xe,De,Ee,Ae,Te;const{enableRtl:v,enableRipple:u,localDataCount:s,isTextWrapData:g,isDialogInsideGrid:h,isStrictMode:D,isMultipleChildren:M,enableDarkMode:A=!1,builtInThemes:ee="material",parentContainerHeight:un="87vh",isCustomBinding:P,serverPageSize:ne,defaultOpenGroupExpandKeys:k,isConditionalRowSelection:ye,...n}=r;((De=(xe=n.columns)==null?void 0:xe[((be=n.columns)==null?void 0:be.length)-1])==null?void 0:De.headerText)==="Command Actions"&&(n.columns[((Ee=n.columns)==null?void 0:Ee.length)-1].getCommandItems=()=>[a.jsx(R,{type:G.Edit},"Edit"),a.jsx(R,{type:G.Delete},"Delete"),a.jsx(R,{type:G.Update},"Update"),a.jsx(R,{type:G.Cancel},"Cancel")]);const S=p.useRef(null),he=p.useRef(null),[fe,cn]=p.useState(!0),[F,pn]=p.useState(!1);vn(ee,n.enableDevMode);const C=p.useMemo(()=>g?qn(s):Vn(s,n.columns),[s,(Ae=n.columns)==null?void 0:Ae.length]),[mn,gn]=p.useState({result:[],count:0,hasMore:((Te=r.virtualizationSettings)==null?void 0:Te.scrollMode)===y.Infinite}),Se=p.useCallback(e=>{if(!e.isComplex)return new Re(e.field,e.operator,e.value,e.ignoreCase,e.ignoreAccent,e.matchCase);let t=null;const o=e.predicates||[],c=e.condition||"and";for(let m=0;m<o.length;m++){const d=Se(e.predicates[m]);t===null?t=d:t=c.toLowerCase()==="or"?t.or(d):t.and(d)}return t||new Re("","","")},[]),ve=p.useCallback(e=>{var c,m,d,f,E,b,q,N,L,j,W,H,U,B,K,V,Q,z,_,I,$,J,X;const t=new ge(C),o=new me;if((c=e.where)!=null&&c.length){const i=e.where[0],l=Se(i);o.where(l)}if((m=e.search)!=null&&m.length){const{fields:i,value:l}=e.search[0];o.search(l,i)}if((d=e.sort)!=null&&d.length||(f=e.groups)!=null&&f.length&&e.isInitialLoad)if(e.isInitialLoad&&((E=e.groups)!=null&&E.length)){const i=[];for(let l=e.sort.length-1;l>-1;l--)(i==null?void 0:i.find(w=>w.field===e.sort[l].field))||((b=e.groups)!=null&&b.length&&((q=e.groups)!=null&&q.includes(e.sort[l].field))?i.push({field:e.sort[l].field,direction:e.sort[l].direction}):o.sortBy(e.sort[l].field,e.sort[l].direction));i.length&&i.forEach(l=>{o.sortBy(l.field,l.direction)})}else e.sort.forEach(i=>{o.sortBy(i.field,i.direction)});if((N=e.aggregates)!=null&&N.length||(j=(L=S.current)==null?void 0:L.aggregates)!=null&&j.length){const i=(W=e.aggregates)!=null&&W.length?e.aggregates:(H=S.current)==null?void 0:H.aggregates;for(let l=0;l<(i==null?void 0:i.length);l++)if((U=i[l])!=null&&U.columns)for(let x=0;x<((B=i[l])==null?void 0:B.columns.length);x++){const w=i[l].columns[x];if(Array.isArray(w.type))for(let Y=0;Y<w.type.length;Y++)o.aggregate((Q=(V=(K=w.type)==null?void 0:K[Y])==null?void 0:V.toLowerCase)==null?void 0:Q.call(V),w.field);else o.aggregate((_=(z=w.type)==null?void 0:z.toLowerCase)==null?void 0:_.call(z),w.field)}else{const x=i[l];o.aggregate(($=(I=x.type)==null?void 0:I.toLowerCase)==null?void 0:$.call(I),x.field)}}if(e.groups&&((J=e.groups)!=null&&J.length))for(let i=0;i<e.groups.length;i++){const l=e.groups[parseInt(i.toString(),10)];o.group(l)}if(e.take&&e.skip){const i=e.skip/e.take+1,l=e.take;o.page(i,l)}else if(e.skip===0&&e.take)o.page(1,e.take);else if(!bn(e.skip)&&!e.take&&((X=r.virtualizationSettings)==null?void 0:X.scrollMode)===y.Infinite){const i=e.skip/ne+1;o.page(i,ne)}e.requiresCounts&&o.requiresCount(),console.log("onDataRequest => ",e,o),t.executeQuery(o).then(i=>{if(e.requestType==="filterChoiceRequest"){const l={result:Ge.distinct(i.result,e.select[0],!0),count:i.count};if(e.distinctCounts){const x=new me;if(e.distinct){const w=e.distinct[0],Y=Se(w);x.where(Y)}e.select&&x.select(e.select),console.log("onDataRequest => ",e,o),t.executeQuery(x).then(w=>{l.distinctCount=Ge.distinct(w.result,e.select[0],!0).length,e.dataSource(l)})}else e.dataSource(l)}else gn({...i,hasMore:C.length>(e.skip??0)+i.result.length})})},[]),hn=p.useCallback(e=>{setTimeout(()=>{if(console.log("onDataChangeRequest => ",e),Array.isArray(e.data)){e.data.forEach(t=>{const o=C.findIndex(c=>c.id===t.id);o!==-1&&(C[o]={...C[o],...t})}),e.saveDataChanges();return}if(e.action==="Add"&&C.unshift(e.data),e.action==="Edit"){for(let t=0;t<C.length;t++)if(C[t].id===e.data.id){C[t]=e.data;break}}if(e.action==="Delete"){for(let t=0;t<e.data.length;t++)for(let o=0;o<C.length;o++)if(C[o].id===e.data[t].id){C.splice(o,1);break}}e.saveDataChanges()},0)},[]),fn=p.useMemo(()=>{var c,m;if(!P)return;const e=((c=n==null?void 0:n.aggregates)==null?void 0:c.reduce((d,f)=>{var E;return(E=f.columns)==null||E.forEach(b=>{Array.isArray(b.type)?b.type.forEach(q=>{d.push({type:q.toLowerCase(),field:b.field})}):d.push({type:b.type.toLowerCase(),field:b.field})}),d},[]))??[],t=((m=n==null?void 0:n.columns)==null?void 0:m.reduce((d,f)=>(f.groupCaptionAggregateType&&d.push(...Array.isArray(f.groupCaptionAggregateType)?f.groupCaptionAggregateType.map(E=>({type:E.toLowerCase(),field:f.field})):[{type:f.groupCaptionAggregateType.toLowerCase(),field:f.field}]),d),[]))??[],o=e==null?void 0:e.concat(t);return o!=null&&o.length?o:void 0},[P,n==null?void 0:n.aggregates,n==null?void 0:n.columns,F]);p.useEffect(()=>{var e,t,o,c,m,d,f,E,b,q,N,L,j,W,H,U,B,K,V,Q,z,_;P&&F&&ve({skip:((e=n==null?void 0:n.pageSettings)==null?void 0:e.currentPage)*((t=n==null?void 0:n.pageSettings)==null?void 0:t.pageSize)||0,...((o=n.virtualizationSettings)==null?void 0:o.scrollMode)!==y.Infinite||(c=n.pageSettings)!=null&&c.estimatedTotalRecordsCount||((m=n.pageSettings)==null?void 0:m.pageSizeControlledBy)==="client"?{take:ne??((d=n==null?void 0:n.pageSettings)==null?void 0:d.pageSize)??(((f=n.virtualizationSettings)==null?void 0:f.scrollMode)===y.Auto||!((E=n.virtualizationSettings)!=null&&E.scrollMode)?12:50)}:{take:ne},groups:(b=n==null?void 0:n.groupSettings)!=null&&b.enabled?(q=n==null?void 0:n.groupSettings)==null?void 0:q.columns:[],where:[],search:[],sort:(N=n==null?void 0:n.sortSettings)!=null&&N.enabled&&((j=(L=n==null?void 0:n.sortSettings)==null?void 0:L.columns)!=null&&j.length)&&(!((W=n==null?void 0:n.groupSettings)!=null&&W.enabled)||!((H=n==null?void 0:n.groupSettings)!=null&&H.columns))?(U=n==null?void 0:n.sortSettings)==null?void 0:U.columns:(((B=n==null?void 0:n.sortSettings)==null?void 0:B.columns)??[]).concat((K=n==null?void 0:n.groupSettings)!=null&&K.enabled&&((V=n==null?void 0:n.groupSettings)!=null&&V.columns)?(z=(Q=n==null?void 0:n.groupSettings)==null?void 0:Q.columns)==null?void 0:z.map(I=>{var $,J,X;return{field:I,direction:((X=(J=($=n==null?void 0:n.sortSettings)==null?void 0:$.columns)==null?void 0:J.find(i=>i.field===I))==null?void 0:X.direction)??"Ascending"}}):[]),aggregates:fn??[],...((_=n.virtualizationSettings)==null?void 0:_.scrollMode)!==y.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[F]),p.useEffect(()=>{A?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[A]);const Sn=p.useCallback(e=>e.id%2===0||e.EmployeeID%2===0||e.RecordId%2===0?{selectable:!1}:!0,[ye]),Cn=p.useCallback(e=>{var t;return(t=k.includes)==null?void 0:t.call(k,e==null?void 0:e.groupKey)},[k]),wn=p.useCallback(e=>{console.error("Grid Error: ",e)},[n==null?void 0:n.onError]),yn=p.useCallback(e=>Nn[e.rowIndex%4],[n==null?void 0:n.getRowHeight]),te=()=>{var e;return a.jsxs(a.Fragment,{children:[a.jsxs("button",{onClick:()=>{var t,o;F&&window.localStorage.removeItem((o=(t=S==null?void 0:S.current)==null?void 0:t.getDataModule())==null?void 0:o.dataManager.guidId),pn(!F)},children:[F?"Destroy":"Render"," Data Grid"]}),s&&!g&&a.jsxs("button",{onClick:()=>cn(!fe),children:[fe?"Uniform":"Non Uniform"," Row Height Applied"]}),(e=n==null?void 0:n.groupSettings)!=null&&e.enabled?a.jsxs(a.Fragment,{children:[a.jsx("button",{onClick:()=>{var t,o,c;(c=(t=S.current)==null?void 0:t.groupColumn)==null||c.call(t,(o=n==null?void 0:n.groupSettings)==null?void 0:o.columns,!0)},children:"Reset Grouped Columns to Default"}),a.jsx("button",{onClick:()=>{var t,o,c,m,d;(d=(t=S.current)==null?void 0:t.ungroupColumn)==null||d.call(t,[(m=(c=(o=S.current)==null?void 0:o.groupSettings)==null?void 0:c.columns)==null?void 0:m[0]])},children:"Un Group First Grouped Column"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=S.current)==null?void 0:t.expandAll)==null||o.call(t)},children:"Expand All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=S.current)==null?void 0:t.collapseAll)==null||o.call(t)},children:"Collapse All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=S.current)==null?void 0:t.clearGrouping)==null||o.call(t)},children:"Clear Grouping"})]}):null,a.jsx("br",{}),a.jsx("br",{}),F&&a.jsx(xn,{dir:v?"rtl":"ltr",ripple:u,locale:n.locale,children:a.jsx(Dn,{ref:S,dataSource:P?mn:s?C:[],onDataRequest:P?ve:void 0,onDataChangeRequest:P?hn:void 0,shouldExpandGroup:k!=null&&k.length?Cn:void 0,onError:wn,...n,isRowSelectable:ye?Sn:void 0,columns:n.children?void 0:n.columns,modules:{ClipboardModule:zn},aggregates:n.children?void 0:n.aggregates,getRowHeight:fe?null:yn,children:M?n.children.props.children:n.children})}),a.jsx("br",{}),a.jsx("button",{onClick:()=>{console.log(S)},children:"dummy navigation checking button with get GridRef"})]})};return a.jsx("div",{ref:he,style:{height:un,isolation:"isolate"},className:A?"dark sf-dark-mode":"",children:D?a.jsx(p.StrictMode,{children:h?a.jsx(Me,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()}):h?a.jsx(Me,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()})};try{we.displayName="LargeDataGridTest",we.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(Ve=(qe=ae.parameters)==null?void 0:qe.docs)==null?void 0:Ve.source}}};var ze,Ie,Oe;oe.parameters={...oe.parameters,docs:{...(ze=oe.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  args: {
...
}`,...(Oe=(Ie=oe.parameters)==null?void 0:Ie.docs)==null?void 0:Oe.source}}};var Pe,Ne,Le;re.parameters={...re.parameters,docs:{...(Pe=re.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  args: {
...
}`,...(Le=(Ne=re.parameters)==null?void 0:Ne.docs)==null?void 0:Le.source}}};var je,We,He;ie.parameters={...ie.parameters,docs:{...(je=ie.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
...
}`,...(He=(We=ie.parameters)==null?void 0:We.docs)==null?void 0:He.source}}};var Ue,Be,Ke;le.parameters={...le.parameters,docs:{...(Ue=le.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    dataSource: employeeData,
    children: <Columns>\r
