import{j as a}from"./index-CTAXdLKx.js";import{r as w}from"./index-D5jfS-9e.js";import{C as R,a as G,u as Cn,S as y,P as Re,D as Ge,b as ge,Q as me,i as wn,c as Me,d as yn,G as vn,e as bn,f as xn,g as Dn,h as O,W as En,A as Z,j as Ce,k as dn,O as An,T as ke,U as Tn,l as Rn}from"./useGridTheme-aNJoDd_K.js";import"./client-Spw3EFno.js";import{m as Gn,a as Mn,u as kn,e as Fn,b as qn,c as Vn}from"./data-Da9MUFbQ.js";const In=[40,80,120,200],we=r=>{var be,xe,De,Ee,Ae,Te;const{enableRtl:v,enableRipple:u,localDataCount:s,isTextWrapData:m,isDialogInsideGrid:g,isStrictMode:D,isMultipleChildren:M,enableDarkMode:A=!1,builtInThemes:ee="material",parentContainerHeight:un="87vh",isCustomBinding:P,serverPageSize:ne,defaultOpenGroupExpandKeys:z,isConditionalRowSelection:ye,...n}=r;((De=(xe=n.columns)==null?void 0:xe[((be=n.columns)==null?void 0:be.length)-1])==null?void 0:De.headerText)==="Command Actions"&&(n.columns[((Ee=n.columns)==null?void 0:Ee.length)-1].getCommandItems=()=>[a.jsx(R,{type:G.Edit},"Edit"),a.jsx(R,{type:G.Delete},"Delete"),a.jsx(R,{type:G.Update},"Update"),a.jsx(R,{type:G.Cancel},"Cancel")]);const f=w.useRef(null),he=w.useRef(null),[fe,cn]=w.useState(!0),[k,pn]=w.useState(!1);Cn(ee,n.enableDevMode);const S=w.useMemo(()=>m?Gn(s):Mn(s,n.columns),[s,(Ae=n.columns)==null?void 0:Ae.length]),[mn,gn]=w.useState({result:[],count:0,hasMore:((Te=r.virtualizationSettings)==null?void 0:Te.scrollMode)===y.Infinite}),Se=w.useCallback(e=>{if(!e.isComplex)return new Re(e.field,e.operator,e.value,e.ignoreCase,e.ignoreAccent,e.matchCase);let t=null;const o=e.predicates||[],c=e.condition||"and";for(let p=0;p<o.length;p++){const d=Se(e.predicates[p]);t===null?t=d:t=c.toLowerCase()==="or"?t.or(d):t.and(d)}return t||new Re("","","")},[]),ve=e=>{var c,p,d,h,E,b,F,N,L,j,W,U,H,B,K,q,Q,V,_,I,$,J,X;const t=new ge(S),o=new me;if((c=e.where)!=null&&c.length){const i=e.where[0],l=Se(i);o.where(l)}if((p=e.search)!=null&&p.length){const{fields:i,value:l}=e.search[0];o.search(l,i)}if((d=e.sort)!=null&&d.length||(h=e.groups)!=null&&h.length&&e.isInitialLoad)if(e.isInitialLoad&&((E=e.groups)!=null&&E.length)){const i=[];for(let l=e.sort.length-1;l>-1;l--)(i==null?void 0:i.find(C=>C.field===e.sort[l].field))||((b=e.groups)!=null&&b.length&&((F=e.groups)!=null&&F.includes(e.sort[l].field))?i.push({field:e.sort[l].field,direction:e.sort[l].direction}):o.sortBy(e.sort[l].field,e.sort[l].direction));i.length&&i.forEach(l=>{o.sortBy(l.field,l.direction)})}else e.sort.forEach(i=>{o.sortBy(i.field,i.direction)});if((N=e.aggregates)!=null&&N.length||(j=(L=f.current)==null?void 0:L.aggregates)!=null&&j.length){const i=(W=e.aggregates)!=null&&W.length?e.aggregates:(U=f.current)==null?void 0:U.aggregates;for(let l=0;l<(i==null?void 0:i.length);l++)if((H=i[l])!=null&&H.columns)for(let x=0;x<((B=i[l])==null?void 0:B.columns.length);x++){const C=i[l].columns[x];if(Array.isArray(C.type))for(let Y=0;Y<C.type.length;Y++)o.aggregate((Q=(q=(K=C.type)==null?void 0:K[Y])==null?void 0:q.toLowerCase)==null?void 0:Q.call(q),C.field);else o.aggregate((_=(V=C.type)==null?void 0:V.toLowerCase)==null?void 0:_.call(V),C.field)}else{const x=i[l];o.aggregate(($=(I=x.type)==null?void 0:I.toLowerCase)==null?void 0:$.call(I),x.field)}}if(e.groups&&((J=e.groups)!=null&&J.length))for(let i=0;i<e.groups.length;i++){const l=e.groups[parseInt(i.toString(),10)];o.group(l)}if(e.take&&e.skip){const i=e.skip/e.take+1,l=e.take;o.page(i,l)}else if(e.skip===0&&e.take)o.page(1,e.take);else if(!wn(e.skip)&&!e.take&&((X=r.virtualizationSettings)==null?void 0:X.scrollMode)===y.Infinite){const i=e.skip/ne+1;o.page(i,ne)}e.requiresCounts&&o.requiresCount(),t.executeQuery(o).then(i=>{if(e.requestType==="filterChoiceRequest"){const l={result:Me.distinct(i.result,e.select[0],!0),count:i.count};if(e.distinctCounts){const x=new me;if(e.distinct){const C=e.distinct[0],Y=Se(C);x.where(Y)}e.select&&x.select(e.select),t.executeQuery(x).then(C=>{l.distinctCount=Me.distinct(C.result,e.select[0],!0).length,e.dataSource(l)})}else e.dataSource(l)}else gn({...i,hasMore:S.length>(e.skip??0)+i.result.length})})},hn=e=>{setTimeout(()=>{if(Array.isArray(e.data)){e.data.forEach(t=>{const o=S.findIndex(c=>c.id===t.id);o!==-1&&(S[o]={...S[o],...t})}),e.saveDataChanges();return}if(e.action==="Add"&&S.unshift(e.data),e.action==="Edit"){for(let t=0;t<S.length;t++)if(S[t].id===e.data.id){S[t]=e.data;break}}if(e.action==="Delete"){for(let t=0;t<e.data.length;t++)for(let o=0;o<S.length;o++)if(S[o].id===e.data[t].id){S.splice(o,1);break}}e.saveDataChanges()},0)},fn=w.useMemo(()=>{var c,p;if(!P)return;const e=((c=n==null?void 0:n.aggregates)==null?void 0:c.reduce((d,h)=>{var E;return(E=h.columns)==null||E.forEach(b=>{Array.isArray(b.type)?b.type.forEach(F=>{d.push({type:F.toLowerCase(),field:b.field})}):d.push({type:b.type.toLowerCase(),field:b.field})}),d},[]))??[],t=((p=n==null?void 0:n.columns)==null?void 0:p.reduce((d,h)=>(h.groupCaptionAggregateType&&d.push(...Array.isArray(h.groupCaptionAggregateType)?h.groupCaptionAggregateType.map(E=>({type:E.toLowerCase(),field:h.field})):[{type:h.groupCaptionAggregateType.toLowerCase(),field:h.field}]),d),[]))??[],o=e==null?void 0:e.concat(t);return o!=null&&o.length?o:void 0},[P,n==null?void 0:n.aggregates,n==null?void 0:n.columns,k]);w.useEffect(()=>{var e,t,o,c,p,d,h,E,b,F,N,L,j,W,U,H,B,K,q,Q,V,_;P&&k&&ve({skip:((e=n==null?void 0:n.pageSettings)==null?void 0:e.currentPage)*((t=n==null?void 0:n.pageSettings)==null?void 0:t.pageSize)||0,...((o=n.virtualizationSettings)==null?void 0:o.scrollMode)!==y.Infinite||(c=n.pageSettings)!=null&&c.estimatedTotalRecordsCount||((p=n.pageSettings)==null?void 0:p.pageSizeControlledBy)==="client"?{take:ne??((d=n==null?void 0:n.pageSettings)==null?void 0:d.pageSize)??(((h=n.virtualizationSettings)==null?void 0:h.scrollMode)===y.Auto||!((E=n.virtualizationSettings)!=null&&E.scrollMode)?12:50)}:{take:ne},groups:(b=n==null?void 0:n.groupSettings)!=null&&b.enabled?(F=n==null?void 0:n.groupSettings)==null?void 0:F.columns:[],where:[],search:[],sort:(N=n==null?void 0:n.sortSettings)!=null&&N.enabled&&((j=(L=n==null?void 0:n.sortSettings)==null?void 0:L.columns)!=null&&j.length)&&(!((W=n==null?void 0:n.groupSettings)!=null&&W.enabled)||!((U=n==null?void 0:n.groupSettings)!=null&&U.columns))?(H=n==null?void 0:n.sortSettings)==null?void 0:H.columns:(((B=n==null?void 0:n.sortSettings)==null?void 0:B.columns)??[]).concat((K=n==null?void 0:n.groupSettings)!=null&&K.enabled&&((q=n==null?void 0:n.groupSettings)!=null&&q.columns)?(V=(Q=n==null?void 0:n.groupSettings)==null?void 0:Q.columns)==null?void 0:V.map(I=>{var $,J,X;return{field:I,direction:((X=(J=($=n==null?void 0:n.sortSettings)==null?void 0:$.columns)==null?void 0:J.find(i=>i.field===I))==null?void 0:X.direction)??"Ascending"}}):[]),aggregates:fn??[],...((_=n.virtualizationSettings)==null?void 0:_.scrollMode)!==y.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[k]),w.useEffect(()=>{A?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[A]);const Sn=w.useCallback(e=>e.id%2===0||e.EmployeeID%2===0||e.RecordId%2===0?{selectable:!1}:!0,[ye]),te=()=>{var e;return a.jsxs(a.Fragment,{children:[a.jsxs("button",{onClick:()=>{var t,o;k&&window.localStorage.removeItem((o=(t=f==null?void 0:f.current)==null?void 0:t.getDataModule())==null?void 0:o.dataManager.guidId),pn(!k)},children:[k?"Destroy":"Render"," Data Grid"]}),s&&!m&&a.jsxs("button",{onClick:()=>cn(!fe),children:[fe?"Uniform":"Non Uniform"," Row Height Applied"]}),(e=n==null?void 0:n.groupSettings)!=null&&e.enabled?a.jsxs(a.Fragment,{children:[a.jsx("button",{onClick:()=>{var t,o,c;(c=(t=f.current)==null?void 0:t.groupColumn)==null||c.call(t,(o=n==null?void 0:n.groupSettings)==null?void 0:o.columns,!0)},children:"Reset Grouped Columns to Default"}),a.jsx("button",{onClick:()=>{var t,o,c,p,d;(d=(t=f.current)==null?void 0:t.ungroupColumn)==null||d.call(t,[(p=(c=(o=f.current)==null?void 0:o.groupSettings)==null?void 0:c.columns)==null?void 0:p[0]])},children:"Un Group First Grouped Column"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.expandAll)==null||o.call(t)},children:"Expand All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.collapseAll)==null||o.call(t)},children:"Collapse All"}),a.jsx("button",{onClick:()=>{var t,o;(o=(t=f.current)==null?void 0:t.clearGrouping)==null||o.call(t)},children:"Clear Grouping"})]}):null,a.jsx("br",{}),a.jsx("br",{}),k&&a.jsx(yn,{dir:v?"rtl":"ltr",ripple:u,locale:n.locale,children:a.jsx(vn,{ref:f,dataSource:P?mn:s?S:[],onDataRequest:P?ve:void 0,onDataChangeRequest:P?hn:void 0,shouldExpandGroup:z!=null&&z.length?t=>{var o;return(o=z.includes)==null?void 0:o.call(z,t==null?void 0:t.groupKey)}:void 0,onError:t=>{console.error("Grid Error: ",t)},...n,isRowSelectable:ye?Sn:void 0,columns:n.children?void 0:n.columns,modules:{ClipboardModule:kn},aggregates:n.children?void 0:n.aggregates,getRowHeight:fe?null:t=>In[t.rowIndex%4],children:M?n.children.props.children:n.children})}),a.jsx("br",{}),a.jsx("button",{onClick:()=>{console.log(f)},children:"dummy navigation checking button with get GridRef"})]})};return a.jsx("div",{ref:he,style:{height:un,isolation:"isolate"},className:A?"dark sf-dark-mode":"",children:D?a.jsx(w.StrictMode,{children:g?a.jsx(Ge,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()}):g?a.jsx(Ge,{open:!0,fullScreen:!0,target:he.current,children:te()}):te()})};try{we.displayName="LargeDataGridTest",we.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
}`,...(Le=(Ne=re.parameters)==null?void 0:Ne.docs)==null?void 0:Le.source}}};var je,We,Ue;ie.parameters={...ie.parameters,docs:{...(je=ie.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    dataSource: new DataManager({
