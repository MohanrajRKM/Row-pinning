import{j as t}from"./index-CTAXdLKx.js";import{r as p}from"./index-D5jfS-9e.js";import{C as U,a as H,u as Nn,S as y,P as He,D as Ge,Q as Re,i as jn,b as Be,c as Ke,d as Ln,G as Wn,e as V,f as Un,g as Hn,h as Bn,j as Kn,k as Y,W as Qn,A as ge,l as q,m as Ve,O as _n,T as Qe,U as $n,n as Jn}from"./useGridTheme-CsoYJW4o.js";import"./client-Spw3EFno.js";import{m as Xn,a as Yn,u as I,b as P,c as O,d as N,e as j,f as M,g as D,h as A,i as E,j as T,k as R,l as G,n as F,o as Zn,p as et,q as nt}from"./data-856ROLTy.js";const tt=[40,80,120,200],qe=r=>{var Oe,Ne,je,Le,We,Ue;const{enableRtl:v,enableRipple:u,localDataCount:s,isTextWrapData:g,isDialogInsideGrid:h,isStrictMode:k,isMultipleChildren:B,enableDarkMode:L=!1,builtInThemes:he="material",parentContainerHeight:Tn="87vh",isCustomBinding:Z,serverPageSize:fe,defaultOpenGroupExpandKeys:K,isConditionalRowSelection:Ie,...n}=r;((je=(Ne=n.columns)==null?void 0:Ne[((Oe=n.columns)==null?void 0:Oe.length)-1])==null?void 0:je.headerText)==="Command Actions"&&(n.columns[((Le=n.columns)==null?void 0:Le.length)-1].getCommandItems=()=>[t.jsx(U,{type:H.Edit},"Edit"),t.jsx(U,{type:H.Delete},"Delete"),t.jsx(U,{type:H.Update},"Update"),t.jsx(U,{type:H.Cancel},"Cancel")]);const C=p.useRef(null),Fe=p.useRef(null),[ke,Rn]=p.useState(!0),[Q,Gn]=p.useState(!1);Nn(he,n.enableDevMode);const S=p.useMemo(()=>g?Xn(s):Yn(s,n.columns),[s,(We=n.columns)==null?void 0:We.length]),[Fn,kn]=p.useState({result:[],count:0,hasMore:((Ue=r.virtualizationSettings)==null?void 0:Ue.scrollMode)===y.Infinite}),ze=p.useCallback(e=>{if(!e.isComplex)return new He(e.field,e.operator,e.value,e.ignoreCase,e.ignoreAccent,e.matchCase);let o=null;const a=e.predicates||[],c=e.condition||"and";for(let m=0;m<a.length;m++){const d=ze(e.predicates[m]);o===null?o=d:o=c.toLowerCase()==="or"?o.or(d):o.and(d)}return o||new He("","","")},[]),Pe=p.useCallback(e=>{var c,m,d,f,z,b,_,ee,ne,te,oe,ae,re,le,ie,$,se,J,de,X,ue,ce,pe;const o=new Ge(S),a=new Re;if((c=e.where)!=null&&c.length){const l=e.where[0],i=ze(l);a.where(i)}if((m=e.search)!=null&&m.length){const{fields:l,value:i}=e.search[0];a.search(i,l)}if((d=e.sort)!=null&&d.length||(f=e.groups)!=null&&f.length&&e.isInitialLoad)if(e.isInitialLoad&&((z=e.groups)!=null&&z.length)){const l=[];for(let i=e.sort.length-1;i>-1;i--)(l==null?void 0:l.find(w=>w.field===e.sort[i].field))||((b=e.groups)!=null&&b.length&&((_=e.groups)!=null&&_.includes(e.sort[i].field))?l.push({field:e.sort[i].field,direction:e.sort[i].direction}):a.sortBy(e.sort[i].field,e.sort[i].direction));l.length&&l.forEach(i=>{a.sortBy(i.field,i.direction)})}else e.sort.forEach(l=>{a.sortBy(l.field,l.direction)});if((ee=e.aggregates)!=null&&ee.length||(te=(ne=C.current)==null?void 0:ne.aggregates)!=null&&te.length){const l=(oe=e.aggregates)!=null&&oe.length?e.aggregates:(ae=C.current)==null?void 0:ae.aggregates;for(let i=0;i<(l==null?void 0:l.length);i++)if((re=l[i])!=null&&re.columns)for(let x=0;x<((le=l[i])==null?void 0:le.columns.length);x++){const w=l[i].columns[x];if(Array.isArray(w.type))for(let me=0;me<w.type.length;me++)a.aggregate((se=($=(ie=w.type)==null?void 0:ie[me])==null?void 0:$.toLowerCase)==null?void 0:se.call($),w.field);else a.aggregate((de=(J=w.type)==null?void 0:J.toLowerCase)==null?void 0:de.call(J),w.field)}else{const x=l[i];a.aggregate((ue=(X=x.type)==null?void 0:X.toLowerCase)==null?void 0:ue.call(X),x.field)}}if(e.groups&&((ce=e.groups)!=null&&ce.length))for(let l=0;l<e.groups.length;l++){const i=e.groups[parseInt(l.toString(),10)];a.group(i)}if(e.take&&e.skip){const l=e.skip/e.take+1,i=e.take;a.page(l,i)}else if(e.skip===0&&e.take)a.page(1,e.take);else if(!jn(e.skip)&&!e.take&&((pe=r.virtualizationSettings)==null?void 0:pe.scrollMode)===y.Infinite){const l=e.skip/fe+1;a.page(l,fe)}e.requiresCounts&&a.requiresCount(),console.log("onDataRequest => ",e,a),o.executeQuery(a).then(l=>{if(e.requestType==="filterChoiceRequest"){const i={result:Be.distinct(l.result,e.select[0],!0),count:l.count};if(e.distinctCounts){const x=new Re;if(e.distinct){const w=e.distinct[0],me=ze(w);x.where(me)}e.select&&x.select(e.select),console.log("onDataRequest => ",e,a),o.executeQuery(x).then(w=>{i.distinctCount=Be.distinct(w.result,e.select[0],!0).length,e.dataSource(i)})}else e.dataSource(i)}else kn({...l,hasMore:S.length>(e.skip??0)+l.result.length})})},[]),zn=p.useCallback(e=>{setTimeout(()=>{if(console.log("onDataChangeRequest => ",e),Array.isArray(e.data)){e.data.forEach(o=>{const a=S.findIndex(c=>c.id===o.id);a!==-1&&(S[a]={...S[a],...o})}),e.saveDataChanges();return}if(e.action==="Add"&&S.unshift(e.data),e.action==="Edit"){for(let o=0;o<S.length;o++)if(S[o].id===e.data.id){S[o]=e.data;break}}if(e.action==="Delete"){for(let o=0;o<e.data.length;o++)for(let a=0;a<S.length;a++)if(S[a].id===e.data[o].id){S.splice(a,1);break}}e.saveDataChanges()},0)},[]),qn=p.useMemo(()=>{var c,m;if(!Z)return;const e=((c=n==null?void 0:n.aggregates)==null?void 0:c.reduce((d,f)=>{var z;return(z=f.columns)==null||z.forEach(b=>{Array.isArray(b.type)?b.type.forEach(_=>{d.push({type:_.toLowerCase(),field:b.field})}):d.push({type:b.type.toLowerCase(),field:b.field})}),d},[]))??[],o=((m=n==null?void 0:n.columns)==null?void 0:m.reduce((d,f)=>(f.groupCaptionAggregateType&&d.push(...Array.isArray(f.groupCaptionAggregateType)?f.groupCaptionAggregateType.map(z=>({type:z.toLowerCase(),field:f.field})):[{type:f.groupCaptionAggregateType.toLowerCase(),field:f.field}]),d),[]))??[],a=e==null?void 0:e.concat(o);return a!=null&&a.length?a:void 0},[Z,n==null?void 0:n.aggregates,n==null?void 0:n.columns,Q]);p.useEffect(()=>{var e,o,a,c,m,d,f,z,b,_,ee,ne,te,oe,ae,re,le,ie,$,se,J,de;Z&&Q&&Pe({skip:((e=n==null?void 0:n.pageSettings)==null?void 0:e.currentPage)*((o=n==null?void 0:n.pageSettings)==null?void 0:o.pageSize)||0,...((a=n.virtualizationSettings)==null?void 0:a.scrollMode)!==y.Infinite||(c=n.pageSettings)!=null&&c.estimatedTotalRecordsCount||((m=n.pageSettings)==null?void 0:m.pageSizeControlledBy)==="client"?{take:fe??((d=n==null?void 0:n.pageSettings)==null?void 0:d.pageSize)??(((f=n.virtualizationSettings)==null?void 0:f.scrollMode)===y.Auto||!((z=n.virtualizationSettings)!=null&&z.scrollMode)?12:50)}:{take:fe},groups:(b=n==null?void 0:n.groupSettings)!=null&&b.enabled?(_=n==null?void 0:n.groupSettings)==null?void 0:_.columns:[],where:[],search:[],sort:(ee=n==null?void 0:n.sortSettings)!=null&&ee.enabled&&((te=(ne=n==null?void 0:n.sortSettings)==null?void 0:ne.columns)!=null&&te.length)&&(!((oe=n==null?void 0:n.groupSettings)!=null&&oe.enabled)||!((ae=n==null?void 0:n.groupSettings)!=null&&ae.columns))?(re=n==null?void 0:n.sortSettings)==null?void 0:re.columns:(((le=n==null?void 0:n.sortSettings)==null?void 0:le.columns)??[]).concat((ie=n==null?void 0:n.groupSettings)!=null&&ie.enabled&&(($=n==null?void 0:n.groupSettings)!=null&&$.columns)?(J=(se=n==null?void 0:n.groupSettings)==null?void 0:se.columns)==null?void 0:J.map(X=>{var ue,ce,pe;return{field:X,direction:((pe=(ce=(ue=n==null?void 0:n.sortSettings)==null?void 0:ue.columns)==null?void 0:ce.find(l=>l.field===X))==null?void 0:pe.direction)??"Ascending"}}):[]),aggregates:qn??[],...((de=n.virtualizationSettings)==null?void 0:de.scrollMode)!==y.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[Q]),p.useEffect(()=>{L?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[L]);const Vn=p.useCallback(e=>e.id%2===0||e.EmployeeID%2===0||e.RecordId%2===0?{selectable:!1}:!0,[Ie]),In=p.useCallback(e=>{var o;return(o=K.includes)==null?void 0:o.call(K,e==null?void 0:e.groupKey)},[K]),Pn=p.useCallback(e=>{console.error("Grid Error: ",e)},[n==null?void 0:n.onError]),On=p.useCallback(e=>tt[e.rowIndex%4],[n==null?void 0:n.getRowHeight]),Ce=()=>{var e;return t.jsxs(t.Fragment,{children:[t.jsxs("button",{onClick:()=>{var o,a;Q&&window.localStorage.removeItem((a=(o=C==null?void 0:C.current)==null?void 0:o.getDataModule())==null?void 0:a.dataManager.guidId),Gn(!Q)},children:[Q?"Destroy":"Render"," Data Grid"]}),s&&!g&&t.jsxs("button",{onClick:()=>Rn(!ke),children:[ke?"Uniform":"Non Uniform"," Row Height Applied"]}),(e=n==null?void 0:n.groupSettings)!=null&&e.enabled?t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>{var o,a,c;(c=(o=C.current)==null?void 0:o.groupColumn)==null||c.call(o,(a=n==null?void 0:n.groupSettings)==null?void 0:a.columns,!0)},children:"Reset Grouped Columns to Default"}),t.jsx("button",{onClick:()=>{var o,a,c,m,d;(d=(o=C.current)==null?void 0:o.ungroupColumn)==null||d.call(o,[(m=(c=(a=C.current)==null?void 0:a.groupSettings)==null?void 0:c.columns)==null?void 0:m[0]])},children:"Un Group First Grouped Column"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.expandAll)==null||a.call(o)},children:"Expand All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.collapseAll)==null||a.call(o)},children:"Collapse All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.clearGrouping)==null||a.call(o)},children:"Clear Grouping"})]}):null,t.jsx("br",{}),t.jsx("br",{}),Q&&t.jsx(Ln,{dir:v?"rtl":"ltr",ripple:u,locale:n.locale,children:t.jsx(Wn,{ref:C,dataSource:Z?Fn:s?S:[],onDataRequest:Z?Pe:void 0,onDataChangeRequest:Z?zn:void 0,shouldExpandGroup:K!=null&&K.length?In:void 0,onError:Pn,...n,isRowSelectable:Ie?Vn:void 0,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:ke?null:On,children:B?n.children.props.children:n.children})}),t.jsx("br",{}),t.jsx("button",{onClick:()=>{console.log(C)},children:"dummy navigation checking button with get GridRef"})]})};return t.jsx("div",{ref:Fe,style:{height:Tn,isolation:"isolate"},className:L?"dark sf-dark-mode":"",children:k?t.jsx(p.StrictMode,{children:h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()}):h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()})};try{qe.displayName="LargeDataGridTest",qe.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
/>
\`\`\``,name:"enableDevMode",required:!1,type:{name:"boolean"}},rowNumberSettings:{defaultValue:{value:"{ enabled: false }"},description:`Configures the display of sequential row numbers in the grid.
@example \`\`\`tsx
<Grid
  dataSource={employees}
  columns={columns}
...
/>
\`\`\``,name:"rowNumberSettings",required:!1,type:{name:"RowNumberSettings"}},allowKeyboard:{defaultValue:{value:"true"},description:`Controls whether keyboard navigation is enabled for the Data Grid.
...
\`\`\``,name:"enableAltRow",required:!1,type:{name:"boolean"}},dragAndDropSettings:{defaultValue:{value:"{ enabled: false }"},description:`Configures row drag-and-drop between grid instances.
@example \`\`\`tsx
<Grid
  dataSource={employees}
  columns={columns}
...
/>
\`\`\``,name:"dragAndDropSettings",required:!1,type:{name:"DragAndDropSettings"}},selectionSettings:{defaultValue:{value:"{ enabled: true, mode: 'Single', enableToggle: true }"},description:`Configures the grid's selection settings, determines whether \`Single\` or \`Multiple\` selections are allowed.
...
/>
\`\`\``,name:"selectionSettings",required:!1,type:{name:"SelectionSettings"}},autoFillSettings:{defaultValue:{value:"undefined"},description:`Enables cell fill (autofill) behavior when selection and editing are active.
...
/>
\`\`\``,name:"autoFillSettings",required:!1,type:{name:"AutoFillSettings"}},onCellFillStart:{defaultValue:null,description:`Fires when a cell fill operation begins.
@event onCellFillStart
@param args - Fill start event arguments
@returns`,name:"onCellFillStart",required:!1,type:{name:"(args: CellFillStartedEvent) => void"}},onCellFillComplete:{defaultValue:null,description:`Fires when a cell fill operation completes.
@event onCellFillComplete
@param args - Fill complete event arguments
@returns`,name:"onCellFillComplete",required:!1,type:{name:"(args: CellFillCompletedEvent<unknown>) => void"}},clipboardSettings:{defaultValue:{value:"{ enabled: true }"},description:`Configures clipboard copy and paste functionality for the grid.
...
\`\`\``,name:"onSearch",required:!1,type:{name:"(event: SearchEvent) => void"}},onColumnResizeStart:{defaultValue:null,description:`Fires when a column resize interaction begins.
...
@param event - Event arguments containing the target column, current width, and a cancelable flag.
@returns
@example \`\`\`tsx
...
\`\`\``,name:"onColumnResizeStart",required:!1,type:{name:"(event: ColumnResizeStartEvent) => void"}},onColumnResize:{defaultValue:null,description:`Fires as the column width changes during an active resize interaction.
...
@param event - Event arguments containing the target column and the new width in pixels.
@returns
@example \`\`\`tsx
...
\`\`\``,name:"onColumnResize",required:!1,type:{name:"(event: ColumnResizeEvent) => void"}},onColumnResizeEnd:{defaultValue:null,description:`Fires when a column resize interaction ends.
...
@param event - Event arguments containing the target column and the final width in pixels.
@returns
@example \`\`\`tsx
...
\`\`\``,name:"onRowSelect",required:!1,type:{name:"(event: RowSelectEvent<unknown>) => void"}},onRowDragStart:{defaultValue:null,description:`Fires when a data row drag operation starts.
@event onRowDragStart
@param args - Dragged rows and source index.
@returns`,name:"onRowDragStart",required:!1,type:{name:"(args: RowDragEventArgs<unknown>) => void"}},onRowDrag:{defaultValue:null,description:`Fires while a data row drag operation is in progress.
@event onRowDrag
@param args - Dragged rows and current target index.
@returns`,name:"onRowDrag",required:!1,type:{name:"(args: RowDragEventArgs<unknown>) => void"}},onRowDrop:{defaultValue:null,description:`Fires when a data row drag operation ends.
@event onRowDrop
@param args - Dragged rows and final target index.
@returns`,name:"onRowDrop",required:!1,type:{name:"(args: RowDragEventArgs<unknown>) => void"}},onRowDeselecting:{defaultValue:null,description:`Fires before a row is deselected.
...
\`\`\``,name:"onClipboardPaste",required:!1,type:{name:"(args: ClipboardPasteEvent) => void"}},isRowPinned:{defaultValue:{value:"undefined"},description:"Callback that determines whether a row should be pinned and to which position.\n\nInvoked for each data row during rendering to determine its pinning bucket.\nReturning `'top'` places the row in the top-pinned section,\nreturning `'bottom'` places it in the bottom-pinned section,\nand returning `null` or `undefined` places it in the regular scrollable section.\n@example ```tsx\n<Grid\n  dataSource={employees}\n  isRowPinned={(row) => row.isPinned ? 'top' : null}\n/>\n```",name:"isRowPinned",required:!1,type:{name:'(row: unknown) => "top" | "bottom"'}},isRowPinnable:{defaultValue:{value:"undefined"},description:`Callback that determines whether a row is eligible for pinning.
...
/>
\`\`\``,name:"isRowPinnable",required:!1,type:{name:"(row: unknown) => boolean"}},rowPinningSettings:{defaultValue:{value:"undefined"},description:`Global configuration settings for row pinning behavior.

Controls whether row pinning is enabled and which directions (top/bottom) are permitted.
@example \`\`\`tsx
<Grid
  dataSource={employees}
  rowPinningSettings={{ enabled: true, allowTopPin: true, allowBottomPin: false }}
  isRowPinned={(row) => row.isPinned ? 'top' : null}
/>
\`\`\``,name:"rowPinningSettings",required:!1,type:{name:"RowPinningSettings"}},onPinnedRowsChange:{defaultValue:null,description:`Fires when the pinned rows change due to user interaction or programmatic update.

Provides the updated lists of top-pinned and bottom-pinned rows along with the action performed.
@event onPinnedRowsChange
@example \`\`\`tsx
const GridComponent = () => {
  const handlePinnedRowsChange = (event: RowPinningEvent) => {
    console.log('Pinned top rows:', event.pinnedTopRows);
    console.log('Pinned bottom rows:', event.pinnedBottomRows);
  };

  return (
    <Grid
      dataSource={employees}
      onPinnedRowsChange={handlePinnedRowsChange}
    />
  );
};
\`\`\``,name:"onPinnedRowsChange",required:!1,type:{name:"(event: RowPinningEvent<unknown>) => void"}}}}}catch{}const ut={title:"Grid/VirtualGridBase",component:qe,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"},builtInThemes:{control:"select",options:["bootstrap","tailwind","material"],description:"Grid Built-in Themes"}}},W=nt(100,!1),ot=[{columns:et(W.length)}];W.unshift({type:Y.Checkbox,width:50,allowFilter:!1});W.push({headerText:"Command Actions",width:200,getCommandItems:()=>[t.jsx(U,{type:H.Edit},"Edit"),t.jsx(U,{type:H.Delete},"Delete"),t.jsx(U,{type:H.Update},"Update"),t.jsx(U,{type:H.Cancel},"Cancel")]});const Se={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e5,columns:(()=>{let r=[...W];return r.unshift({type:Y.SingleGroup}),r=r.map(v=>({...v,...v.field==="sales"?{groupCaptionAggregateType:ge.Min}:{}})),r})(),aggregates:ot,groupSettings:{enabled:!1,columns:["category","product","region"],showDropArea:!0,type:Kn.SingleColumn,defaultExpanded:!0},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:r=>{console.log("Group action: ",r)},onSortStart:()=>{console.log("Sort Started")},onSort:r=>{console.log("Sort action: ",r)},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Gaming Chair","Gaming Chair-South Asia","Tires","Tires-East Asia","Air Conditioner","Air Conditioner-North Africa","Game Controller","Game Controller-South Asia","Mouse","Mouse-South America","Accessories","Accessories-Camera","Accessories-Camera-South America","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Energy","Energy-Tires","Energy-Tires-East Asia","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America"],virtualizationSettings:{scrollMode:y.Virtual,enableCache:!1},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%",onRowSelect:r=>{console.log("Row Selected: ",r)}}},we={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:2e6,isConditionalRowSelection:!0,columns:W.slice(0,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},ye={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://ej2services.syncfusion.com/js/development/api/UrlDataSource",adaptor:new $n}),query:new Re().addParams("dataCount","100000"),toolbar:["Search"],isConditionalRowSelection:!0,groupSettings:{enabled:!1,showDropArea:!0,type:"GroupRows",defaultExpanded:!0,columns:["Designation","Employees"]},onGroup:r=>{console.log("Group action: ",r)},defaultOpenGroupExpandKeys:["CFO","CFO-Kathryn Fuller","Designer","Designer-Kathryn Fuller","Developer","Developer-Kathryn Fuller","Project Lead","Project Lead-Kathryn Fuller","System Analyst","System Analyst-Kathryn Fuller"],columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"EmployeeID",visible:!0,headerText:"Employee ID",isPrimaryKey:!0,width:"150"},{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"},{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"},{field:"Mail",headerText:"Mail",width:"230"},{field:"Location",headerText:"Location",width:"140"},{field:"Status",headerText:"Status",width:"130"},{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"},{field:"Rating",headerText:"Rating",width:"220"},{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"},{field:"CurrentSalary",headerText:"Current Salary",width:"200",format:"C2"},{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"}],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel"},pageSettings:{pageSize:50},virtualizationSettings:{enableCache:!1,scrollMode:y.Virtual},height:"100%"}},ve={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://ej2services.syncfusion.com/react/development/api/GridWebAPIService",adaptor:new Jn}),columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:y.Virtual},height:"100%",query:new Re().addParams("serverpagesize","50")}},be={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:Zn,children:t.jsxs(Ve,{children:[t.jsx(q,{headerText:"Employee Image",width:"180",textAlign:Qe.Center,field:"EmployeeID"}),t.jsx(q,{headerText:"Employee Details",width:"300",textAlign:Qe.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:r=>{const v=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${r.EmployeeID}.png`;return t.jsxs("tr",{className:"templateRow",children:[t.jsx("td",{className:"photo",children:t.jsx("img",{src:v,alt:r.EmployeeID.toString()})}),t.jsx("td",{className:"details",children:t.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[t.jsxs("colgroup",{children:[t.jsx("col",{style:{width:"30%"}}),t.jsx("col",{style:{width:"10%"}})]}),t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"First Name"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.FirstName})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"Last Name"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.LastName})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"Title"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.Title})]})]})]})})]})}}},at=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],xe={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e5,isTextWrapData:!0,columns:at,height:400,textWrapSettings:{enabled:!0,wrapMode:Qn.Both}}},Me={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e3,columns:(()=>{let r=[...W.slice(0,11)];return r.unshift({type:Y.SingleGroup,format:"C2"}),r=r.map(v=>({...v,...v.field==="sales"?{groupCaptionAggregateType:[ge.Min,ge.Max],valueAccessor:u=>{var s,g,h;return((s=u.column)!=null&&s.groupCaptionAggregateType&&((g=u.data)!=null&&g.key)?"Min & Max: ":"")+((h=u.data)==null?void 0:h[u.field])},template:u=>{var s,g,h,k,B,L;return(s=u.column)!=null&&s.groupCaptionAggregateType&&((g=u.data)!=null&&g.key)?`Min & Max: ${(k=u.data)==null?void 0:k[(h=u.column)==null?void 0:h.field]}`:((L=u.data)==null?void 0:L[(B=u.column)==null?void 0:B.field])??""},width:280,format:"C2"}:{}})),r})(),children:(()=>{let r=[...W.slice(0,11)];r.unshift({type:Y.SingleGroup,format:"C2"}),r=r.map(u=>({...u,...u.field==="sales"?{groupCaptionAggregateType:[ge.Min,ge.Max],valueAccessor:s=>{var g,h,k;return((g=s.column)!=null&&g.groupCaptionAggregateType&&((h=s.data)!=null&&h.key)?"Min & Max: ":"")+((k=s.data)==null?void 0:k[s.field])},template:s=>{var g,h,k,B,L,he;return(g=s.column)!=null&&g.groupCaptionAggregateType&&((h=s.data)!=null&&h.key)?`Min & Max: ${(B=s.data)==null?void 0:B[(k=s.column)==null?void 0:k.field]}`:((he=s.data)==null?void 0:he[(L=s.column)==null?void 0:L.field])??""},width:280,format:"C2"}:{}}));const v=r.map(u=>t.jsx(q,{...u}));return t.jsx(Ve,{children:v})})(),gridLines:Bn.Default,rowNumberSettings:{enabled:!0},onDataLoadStart:r=>{console.log("onDataLoadStart: ",r)},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:r=>{console.log("Group action: ",r)},onSortStart:()=>{console.log("Sort Started")},onSort:r=>{console.log("Sort action: ",r)},clipMode:Hn.EllipsisWithTooltip,groupSettings:{enabled:!0,columns:["category","product","region"],defaultExpanded:!0,showDropArea:!0,type:"SingleColumn",captionFormat:"verbose",groupSummaryPosition:Un.Top},sortSettings:{enabled:!0,columns:[{field:"product",direction:"Descending"}]},isCustomBinding:!0,pageSettings:{enabled:!0,pageSize:2},virtualizationSettings:{scrollMode:y.Virtual},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Medical Scanner","Medical Scanner-East Asia","Gaming Chair","Gaming Chair-South Asia","Laptop","Laptop-North America","Tires","Tires-East Asia","Scanner","Scanner-Western Europe","Air Conditioner","Air Conditioner-North Africa","E-learning Tablet","E-learning Tablet-Nordics","Game Controller","Game Controller-South Asia","Whiteboard","Whiteboard-Middle East","Mouse","Mouse-South America","Microwave","Microwave-Sub-Saharan Africa","Accessories","Accessories-Camera","Accessories-Camera-South America","Agriculture","Agriculture-Medical Scanner","Agriculture-Medical Scanner-East Asia","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Electronics","Electronics-Laptop","Electronics-Laptop-North America","Energy","Energy-Tires","Energy-Tires-East Asia","Furniture","Furniture-Scanner","Furniture-Scanner-Western Europe","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Insurance","Insurance-E-learning Tablet","Insurance-E-learning Tablet-Nordics","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Networking","Networking-Whiteboard","Networking-Whiteboard-Middle East","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America","Retail","Retail-Microwave","Retail-Microwave-Sub-Saharan Africa"],editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0,type:"Excel"},height:"100%"}},De={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://services.odata.org/V4/Northwind/Northwind.svc/Orders",adaptor:new _n}),columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"RecordId",headerText:"Record ID",isPrimaryKey:!0},{field:"AssetGroup",headerText:"Asset Group"},{field:"HourlyCost",headerText:"Hourly Cost"},{field:"EstimatedHours",headerText:"Estimated Hours"},{field:"MaintenanceCost",headerText:"Maintenance Cost"},{field:"RequestedDate",headerText:"Requested Date"},{field:"PlannedDate",headerText:"Planned Date"},{field:"CompletionDate",headerText:"Completion Date"},{field:"Status",headerText:"Status"},{field:"RequestOrigin.Division",headerText:"Request Division"}],isConditionalRowSelection:!0,virtualizationSettings:{scrollMode:y.Infinite,enableCache:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",mode:"OnEnter"},onFilterStart:()=>{console.log("Filter Started")},onFilter:r=>{console.log("Filter action: ",r)},pageSettings:{enabled:!0},searchSettings:{enabled:!0},toolbar:["Search"],height:"100%"}},Ae={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},serverPageSize:50,localDataCount:5e3,columns:W.slice(1,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:y.Infinite},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],pageSettings:{enabled:!1,pageSize:50},height:"100%"}},Ee={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:j,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},serverPageSize:50,localDataCount:5e3,columns:W.slice(0,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:y.Virtual},isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],height:"100%"}},Te={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:R,PagerModule:T,GroupModule:E,ToolbarModule:A,ContextMenuModule:D,ColumnChooserModule:M},dataSource:[{OrderID:1,CustomerID:"A",Freight:10,ShipCountry:"USA"},{OrderID:2,CustomerID:"B",Freight:20,ShipCountry:"UK"}],height:400,width:800,selectionSettings:{enabled:!0,type:"Cell",mode:"Multiple"},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},children:t.jsxs(Ve,{children:[t.jsx(q,{field:"OrderID",headerText:"Order ID",width:"120",isPrimaryKey:!0,type:"number"}),t.jsx(q,{field:"CustomerID",headerText:"Customer ID",width:"150"}),t.jsx(q,{field:"Freight",headerText:"Freight",width:"100",format:"C2",type:"number"}),t.jsx(q,{field:"ShipCountry",headerText:"Ship Country",width:"150"}),t.jsx(q,{field:"Complex.ShipCity",headerText:"Ship City",width:"150"}),t.jsx(q,{field:"OrderDate",headerText:"Order Date",width:"140",type:"datetime",format:"yMd"}),t.jsx(q,{field:"isActive",width:"100",type:"boolean"})]})}};var _e,$e,Je;Se.parameters={...Se.parameters,docs:{...(_e=Se.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Je=($e=Se.parameters)==null?void 0:$e.docs)==null?void 0:Je.source}}};var Xe,Ye,Ze;we.parameters={...we.parameters,docs:{...(Xe=we.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Ze=(Ye=we.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.source}}};var en,nn,tn;ye.parameters={...ye.parameters,docs:{...(en=ye.parameters)==null?void 0:en.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(tn=(nn=ye.parameters)==null?void 0:nn.docs)==null?void 0:tn.source}}};var on,an,rn;ve.parameters={...ve.parameters,docs:{...(on=ve.parameters)==null?void 0:on.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(rn=(an=ve.parameters)==null?void 0:an.docs)==null?void 0:rn.source}}};var ln,sn,dn;be.parameters={...be.parameters,docs:{...(ln=be.parameters)==null?void 0:ln.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(dn=(sn=be.parameters)==null?void 0:sn.docs)==null?void 0:dn.source}}};var un,cn,pn;xe.parameters={...xe.parameters,docs:{...(un=xe.parameters)==null?void 0:un.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(pn=(cn=xe.parameters)==null?void 0:cn.docs)==null?void 0:pn.source}}};var mn,gn,hn;Me.parameters={...Me.parameters,docs:{...(mn=Me.parameters)==null?void 0:mn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(hn=(gn=Me.parameters)==null?void 0:gn.docs)==null?void 0:hn.source}}};var fn,Cn,Sn;De.parameters={...De.parameters,docs:{...(fn=De.parameters)==null?void 0:fn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Sn=(Cn=De.parameters)==null?void 0:Cn.docs)==null?void 0:Sn.source}}};var wn,yn,vn;Ae.parameters={...Ae.parameters,docs:{...(wn=Ae.parameters)==null?void 0:wn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(vn=(yn=Ae.parameters)==null?void 0:yn.docs)==null?void 0:vn.source}}};var bn,xn,Mn;Ee.parameters={...Ee.parameters,docs:{...(bn=Ee.parameters)==null?void 0:bn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Mn=(xn=Ee.parameters)==null?void 0:xn.docs)==null?void 0:Mn.source}}};var Dn,An,En;Te.parameters={...Te.parameters,docs:{...(Dn=Te.parameters)==null?void 0:Dn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
    ...
    children: <Columns>\r
            <Column field="OrderID" headerText="Order ID" width="120" isPrimaryKey={true} type='number' />\r
            <Column field="CustomerID" headerText="Customer ID" width="150" />\r
            <Column field="Freight" headerText="Freight" width="100" format='C2' type='number' />\r
            <Column field="ShipCountry" headerText="Ship Country" width="150" />\r
            <Column field="Complex.ShipCity" headerText="Ship City" width="150" />\r
            <Column field="OrderDate" headerText="Order Date" width="140" type="datetime" format='yMd' />\r
            <Column field="isActive" width="100" type="boolean" />\r
        </Columns>
  }
}`,...(En=(An=Te.parameters)==null?void 0:An.docs)==null?void 0:En.source}}};const ct=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample","GroupingSample","ODataV4Sample","CustomBindingSample","conditionalRowSelection","TestGrid"];export{Ae as CustomBindingSample,Me as GroupingSample,Se as LocalData,De as ODataV4Sample,we as OverComeBrowserLimit,be as RowTemplate,Te as TestGrid,xe as TextWrapSample,ye as UrlAdaptorData,ve as WebApiAdaptorData,ct as __namedExportsOrder,Ee as conditionalRowSelection,ut as default};
